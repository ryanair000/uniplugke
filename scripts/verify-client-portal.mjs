...
const netflixHousehold = read("app/api/portal/subscriptions/[id]/netflix-household/route.ts");
...
assert.match(netflixHousehold, /action: "household_update"/);
assert.match(accountAccess, /Approve Household update/);
