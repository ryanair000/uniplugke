  ...
  return (
    <section className="section shell page-top portal-page">
      <div className="dashboard-heading">
        <div><p className="eyebrow">Merchandising</p><h1>Catalog & member plans</h1><p>Control the public service story and the private price plans available after member sign-in.</p></div>
      </div>
      ...
      <div className="admin-grid catalog-form-grid">
        <section className="panel">
          ...
          <h2>Add a service</h2>
          <p className="muted-copy">This content is visible before sign-in. Pricing stays in private member plans.</p>
