...
-- Old /auth/member-link URLs remain valid; new admin-created links use /access/CODE.
...
comment on column public.uniplug_member_access_links.code is
  'Optional human-friendly 10-character access code for private 48-hour member links.';
